  ...
  <div>
    ...
    <base-card>
      <form @submit.prevent="submitForm">
        ...
        <div>
          <base-button class="test">{{ submitButtonCaption }}</base-button>
          <base-button type="button" mode="flat" @click.native="switchAuthMode">{{ switchModeButtonCaption }}</base-button>
        </div>
